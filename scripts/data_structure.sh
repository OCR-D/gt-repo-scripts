...
if test -f "mets.xml"; then
    ...
    if grep -Eq "mets:fileGrp USE=\"OCR-D\-IMG" mets.xml; then
        ...
        ocrd zip bag -i ocrd_data_${var_path1}_${var_path2} -q OCR-D-IMG -q GT-PAGE -q OCR-D-GT-SEG-PAGE -q OCR-D-GT-SEG-BLOCK -q OCR-D-GT-SEG-LINE -q OCR-D-GT-FULLTEXT
