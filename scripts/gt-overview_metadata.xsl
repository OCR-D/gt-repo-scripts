                ...
                <xsl:for-each select="$holeMetric/array/array">
                    ...
                    <xsl:if test="$Image1 != ''">
                       <xsl:if test="$Image2 = $Page">
                            ...
                            ocrd workspace add_file -g P<xsl:number format="0001"/> -G OCR-D-IMG -i OCR-D-IMG_<xsl:number format="0001"/> -m image/<xsl:value-of select="substring-after(tokenize(map/image1, '/')[last()], '.')"/> <xsl:value-of select="$Image2Path"/><xsl:value-of select="tokenize(map/image2,'/')[last()]"/>
                            ocrd workspace add_file -g P<xsl:number format="0001"/> -G OCR-D-GT-SEG-PAGE -i OCR-D-GT-SEG-PAGE_<xsl:number format="0001"/> -m text/xml <xsl:value-of select="substring-after(map/@file, 'file:')"/>
                            ocrd workspace add_file -g P<xsl:number format="0001"/> -G OCR-D-GT-SEG-BLOCK -i OCR-D-GT-SEG-BLOCK_<xsl:number format="0001"/> -m text/xml <xsl:value-of select="substring-after(map/@file, 'file:')"/>
                        </xsl:if>
                    </xsl:if>
                    ...
                    <xsl:if test="$Image3 != ''">
                        <xsl:if test="$Image2 = $Page">
                            ...
                            ocrd workspace add_file -g P<xsl:number format="0001"/> -G OCR-D-IMG -i OCR-D-IMG_<xsl:number format="0001"/> -m image/<xsl:value-of select="substring-after(tokenize(map/image1, '/')[last()], '.')"/> <xsl:value-of select="$Image2Path"/><xsl:value-of select="map/image2"/>
                            ocrd workspace add_file -g P<xsl:number format="0001"/> -G OCR-D-GT-SEG-PAGE -i OCR-D-GT-SEG-PAGE_<xsl:number format="0001"/> -m text/xml <xsl:value-of select="substring-after(map/@file, 'file:')"/>
                            ocrd workspace add_file -g P<xsl:number format="0001"/> -G OCR-D-GT-SEG-BLOCK -i OCR-D-GT-SEG-BLOCK_<xsl:number format="0001"/> -m text/xml <xsl:value-of select="substring-after(map/@file, 'file:')"/>
                        </xsl:if>
                    </xsl:if>
                    ...
                    <xsl:if test="$Image2 = $Page">
                        ...
                        ocrd workspace add_file -g P<xsl:number format="0001"/> -G OCR-D-IMG -i OCR-D-IMG_<xsl:number format="0001"/> -m image/<xsl:value-of select="substring-after(tokenize(map/image2, '/')[last()], '.')"/> <xsl:value-of select="$Image2Path"/><xsl:value-of select="tokenize(map/image2,'/')[last()]"/>
                        ocrd workspace add_file -g P<xsl:number format="0001"/> -G OCR-D-GT-SEG-PAGE -i OCR-D-GT-SEG-PAGE_<xsl:number format="0001"/> -m text/xml <xsl:value-of select="substring-after(map/@file, 'file:')"/>
                        ocrd workspace add_file -g P<xsl:number format="0001"/> -G OCR-D-GT-SEG-BLOCK -i OCR-D-GT-SEG-BLOCK_<xsl:number format="0001"/> -m text/xml <xsl:value-of select="substring-after(map/@file, 'file:')"/>
                    </xsl:if>
                    </xsl:if>
