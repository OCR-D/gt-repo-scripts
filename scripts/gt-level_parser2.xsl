                ...
                <!-- only for TextRegion analyse -->
                        <xsl:when test="document($filename)//pc:PcGts/pc:Page/pc:TextRegion/pc:TextEquiv/pc:Unicode/text() !='' or document($filename)//pt:PcGts/pt:Page/pt:TextRegion/pt:TextEquiv/pt:Unicode/text() !=''">
                            ...
                            <xsl:variable name="TextRegionUnicode">
                                    <xsl:for-each select="document($filename)//pc:PcGts/pc:Page/pc:TextRegion/pc:TextEquiv/pc:Unicode/string-to-codepoints(.)">
                                        <character><xsl:value-of select="codepoints-to-string(.)"/></character>
                                    </xsl:for-each>
                                    <xsl:for-each select="document($filename)//pt:PcGts/pt:Page/pt:TextRegion/pt:TextEquiv/pt:Unicode/string-to-codepoints(.)">
                                        <character><xsl:value-of select="codepoints-to-string(.)"/></character>
                                    </xsl:for-each>
                            </xsl:variable>
                            
                            <xsl:for-each select="distinct-values($TextRegionUnicode//character)">
                                <character>
                                    <xsl:value-of select="."/>
                                </character>
                            </xsl:for-each>
